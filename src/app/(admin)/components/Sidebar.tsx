...
const mainNavItems: NavItem[] = [
  { name: 'Home', path: '/admin/overview', icon: Home },
  { name: 'Products', path: '/admin/products', icon: Package },
  { name: 'Usage Billing', path: '/admin/usage-billing', icon: CreditCard },
  { name: 'Benefits', path: '/admin/benefits', icon: Gift },
  { name: 'Customers', path: '/admin/insights', icon: Users },
  { name: 'Sales', path: '/admin/sales', icon: ShoppingBag },
  { name: 'Analytics', path: '/admin/analytics', icon: BarChart2 },
  { name: 'Finance', path: '/admin/funding', icon: DollarSign },
